...
urlpatterns = [
    ...
    path('reahtmld-/', views.read_html, name='read_html'),
    ...
    path('faculty_everif/', views.student_everif, name='faculty_everif'),
    path('student_dverif/', views.student_direct_verif, name='student_dverif'),
    path('faculty_dverif/', views.faculty_direct_verif, name='faculty_dverif'),
    ...
    path('view_folder_s_l/<str:folder_code>/', views.view_folder_s_l, name='view_folder_s_l'),
    path('view_folder_f_l/<str:folder_code>/', views.view_folder_f_l, name='view_folder_f_l'),
    ...
    path("otp_online/", views.enter_otp_online, name="enter_otp_online"),
    path("change_password_online/", views.send_otp_pass_online, name="change_password_online"),
